                            ...
                            if (res) {
                                ...
                                pastorders.findOne({ uid: uid, "Orders.OrderId": body.ItemsId.split("?")[0] + "?" + body.ItemsId.split("?")[1] }).then(res => {
                                    if (res) {
                                        ...
                                        let orders = { OrderId: body.ItemsId.split("?")[0] + "?" + body.ItemsId.split("?")[1], itemsList: { itemId: body.ItemsId, quantity: body.quantity, deliveredOn: deliveredon, total: total, discount: discount}, deliveryaddress: body.deliveryaddress }
